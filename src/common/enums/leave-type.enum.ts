...
// Common Leave Types
// Annual Leave (Vacation): Paid time off for rest and recreation, often accrued monthly or annually.
// Sick Leave: Paid time for illness or injury, sometimes requiring a doctor's note.
